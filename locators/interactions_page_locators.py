...
class DroppablePageLocators:
    ...
    NOT_GREEDY_DROP_BOX_TEXT = (By.CSS_SELECTOR, "div[id='notGreedyInnerDropBox'] p:nth-child(1)")
    NOT_GREEDY_INNER_BOX = (By.CSS_SELECTOR, "div[id='notGreedyInnerDropBox']")
    GREEDY_DROP_BOX_TEXT = (By.CSS_SELECTOR, "div[id='greedyDropBoxInner'] p:nth-child(1)")
